...
public class SetActivity extends AppCompatActivity {
    ...
    public void RegisterRequest(//信息验证，身份正确且未注册过则跳转
                                final String college, final String no, final String name, final String sex, final String grade,
    ...
    public void Click4(View view) {//保存设置的个人信息，然后返回登录页面
        ...
        //返回登录首页面
        RegisterRequest(College,No,Name,Sex,Grade,Major,UserName,PassWord,Information);
    }
}
